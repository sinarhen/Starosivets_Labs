...
![alt Image not found](https://sinarhen.github.io/Starosivets_Labs/labs/images/1/secondTaskTest.png)

### Завдання 2 

![alt Image not found](https://sinarhen.github.io/Starosivets_Labs/labs/images/1/firstTaskTest.png)
...
B=45, C=10: 
![alt Image not found](https://sinarhen.github.io/Starosivets_Labs/labs/images/1/resultsFirstTask.png)

### Завдання 2
За допомогою калькулятора перевірено результат обчислень. У формулу підставлені значення: X=1, Y=2: 
![alt Image not found](https://sinarhen.github.io/Starosivets_Labs/labs/images/1/resultsSecondTask.png)
